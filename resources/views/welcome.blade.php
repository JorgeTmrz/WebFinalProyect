      ...
      <div id="login">
        ...
        <form action="{{ route('login') }}"  method="POST">
          ...
          <fieldset class="clearfix">
            ...
            <p><span for="email" class="fa fa-user"></span><input type="text" id="email"  name="email" Placeholder="Email" required autofocus></p> <!-- JS because of IE support; better: placeholder="Password" -->
        ...
        @endif
          ...
          <div class="text-danger">* {{ $errors->has('password') ? ' has-error' : '' }}<div>
