...
<div id="content">
    <section class="py-3">
        <div class="container">
           <div class="row">
               <div class="col-lg-9">
                  <h1 class="font-weight-bold mb-0">Bienvenido Esmerlin</h1>
                  <p class="lead text-muted">Revisar la ultimas actualizaciones</p>
             
                </div>
              <div class="col-lg-3 d-flex">
             <button class="btn btn-primary w-100 align-self-center">Reporte del Sistema</button>
               </div>
